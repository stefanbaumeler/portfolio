import { TQDevArticle,
    ...
    TQTravelArticle,
    TQTravelArticles,
    TQTravelPrevNextArticles } from '~/schema'
...
export const isTravelArticle = (article: TQTravelArticle['secret_blog'][number]
    ...
    | TQDevPrevNextArticles['next'][number]
): article is TQTravelArticle['secret_blog'][number] | TQTravelArticles['secret_blog'][number]  => {
